"""Execute a checked joint goal against the current online planning state."""

import dataclasses
import math
from collections.abc import Mapping

from simulation.src.core.actions import JointPositionAction
from simulation.src.core.observations import Observation
from simulation.src.geometry.planning import PlanningQuery
from simulation.src.core.protocols import OnlineEnvironment
