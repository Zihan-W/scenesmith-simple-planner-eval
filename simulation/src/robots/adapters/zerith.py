...
from simulation.src.core.protocols import ContactPolicy, Task
...
from simulation.src.robots.zerith_servo_config import (
    ALL_SERVO_CONFIGS,
    GRIPPER_MAX_OPENING,
...
from simulation.src.robots.zerith_tcp import (
