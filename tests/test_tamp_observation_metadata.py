...
from examples.online_manipulation.tamp_hierarchy import PredicateGoal
from examples.online_manipulation.tamp_scenesmith_online import SceneSmithWorldObserver
...
class ObservationMetadataTest(unittest.TestCase):
    def test_exact_mask_identity_and_semantic_attributes(self):
        ...
        executor = SimpleNamespace(
            ...
            env=SimpleNamespace(backend=SimpleNamespace(capture_cameras=lambda: {"head_camera": camera})),
