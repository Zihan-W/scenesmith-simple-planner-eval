...
from simulation.src.runtime import assembly as run_online
from simulation.examples.example_policies import MyPolicy
...
class GenericOnlineExampleTest(unittest.TestCase):
    ...
    def test_passes_caller_objects_and_options_without_interpretation(self):
        ...
        results = (object(),)
        with (
            mock.patch("simulation.src.runtime.assembly.make_env", return_value=env) as build,
            mock.patch(
                "simulation.src.runtime.assembly.run_episodes", return_value=results
            ) as episodes,
        ):
    ...
    def test_invalid_runner_arguments_fail_before_build(self):
        ...
        with mock.patch("simulation.src.runtime.assembly.make_env") as build:
