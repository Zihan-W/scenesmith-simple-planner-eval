...
from examples.online_manipulation.tamp_diagnostics import measured_contacts, target_flags, json_value, WorkMeter
from src.online_manipulation import RobotCommand, GripperAction
...
class DiagnosticsTest(unittest.TestCase):
    ...
    def test_instrumentation_installs_and_restores_runtime_methods(self):
        from src.online_manipulation.runtime import DrakeRuntime
